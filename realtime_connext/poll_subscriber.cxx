...
class pollListener : public DDSDataReaderListener {
    public:
...
void pollListener::on_data_available(DDSDataReader* reader)
{
    ...
    poll_reader = pollDataReader::narrow(reader);
    if (poll_reader == NULL) {
    ...
    for (i = 0; i < data_seq.length(); ++i) {
        if (info_seq[i].valid_data) {
            pollTypeSupport::print_data(&data_seq[i]);
        }
    }
...
extern "C" int subscriber_main(int domainId, int sample_count)
{
    ...
    DDSTopic *topic = NULL;
    pollListener *reader_listener = NULL; 
    ...
    reader_listener = new pollListener();
    ...
    for (count=0; (sample_count == 0) || (count < sample_count); ++count) {
        ...
        printf("poll subscriber sleeping for %d sec...\n",
                       receive_period.sec);
